...
/* package optparse-declarative-0.3.0 */
#define VERSION_optparse_declarative "0.3.0"
#define MIN_VERSION_optparse_declarative(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  3 || \
...
#define CURRENT_PACKAGE_KEY "ttask_72zq9oHyfMzKhn7BjotlNr"
